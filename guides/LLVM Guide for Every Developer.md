...
* **The llvm-objdump Connection:** Because C++ mangles names, Delphi developers often use llvm-objdump \-t to inspect the C++ object file, find the exact mangled name (e.g., \_\_Z6myFunci), and declare it as an external function in the Pascal source.
